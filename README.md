...
* [Sunon Extruder Fan](https://www.digikey.com/product-detail/en/sunon-fans/MF40100V1-1000U-G99/259-1836-ND/7927772). The stock Noctua fan that ships with the MK3 is weak - something like only 20% as powerful as the fan E3D recommends. This Sunon fan is a replacement fan for the default Noctua fan that ships with the printer. It is much more powerful, at the expense of being louder. But it will help your 602 extrusion issues very much by cooling your heatbreak much better! I highly recommend this fan to replace the stock fan. Make sure you get the MF40100V1-1000U-G99 model, no matter where you order it from. The "V1" denotes the fan speed as "high speed". The V2 is a slower "medium speed" fan and you don't want it.
...
* ~~[Taurus Y Axis](https://www.thingiverse.com/thing:3269389). This is a new Y motor mount and belt system, mostly all printable as well. It is much stronger than the default Y axis parts, and allows you to easily tension your Y axis belt. You may notice a slight increase in print quality with this.~~ AS OF 1/17/2018 JLTX IS NO LONGER OFFERING THE TAURUS Y AXIS FOR DOWNLOAD. CHECK THE MOTOR MOUNT BELOW FOR A BETTER Y MOTOR MOUNT.
* [Juiced Y-Motor Mount](https://www.thingiverse.com/thing:2777432). This is a sturdier Y-motor mount for your MK3 that is more durable and might keep your Y motor and belts aligned better.
